...
![Front and side drawings of the chuck box plans in a dot grid notebook.](/assets/images/chuck_box/design_1.webp)
![Internal view drawings of the chuck box plans in a dot grid notebook showing the rails for the storage bins.](/assets/images/chuck_box/design_2.webp)
...
![A stack of 4 grey plastic bus bins](/assets/images/chuck_box/bus_bins.webp)
...
![A pile of strips of cut plywood.](/assets/images/chuck_box/bones.webp)

Next I constructed two boxes that would make up the right and left sides of the box. 
![Two rectangles created with strips of plywood held together with angle clamps.](/assets/images/chuck_box/box_sides.webp)
...
![A box with no sides created with plywood strip rectangles and thin plywood](/assets/images/chuck_box/frame_up.webp)
...
![A box with no front created with plywood strips and thin plywood.](/assets/images/chuck_box/success.webp)
...
![A green chuck box with camping items stored inside.](/assets/images/chuck_box/painted.webp)
...
![A green chuck box with the storage drawers pulled out showing the contents of the box.](/assets/images/chuck_box/storage.webp)
